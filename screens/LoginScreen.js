  ...
  render() {
    ...
    <View style={styles.inputWrapper}>
        ...
        <TextInput
          ...
          onChangeText = {(text)=>this._assignUsername(text)}
        />
     </View>
       ...
       <View style={styles.containerBottom}>
        <Text style={styles.text}  onPress={() => Linking.openURL('http://google.com/search?q="why do you want sign up?"')}>Create Account</Text>
        <Text style={styles.text} onPress={() => Linking.openURL('http://google.com/search?q="why did you forget it?"')}>Forgot Password?</Text>
      </View>
